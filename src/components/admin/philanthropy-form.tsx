...
export function PhilanthropyForm({ isOpen, onOpenChange, onSubmit, activity, isSubmitting }: PhilanthropyFormProps) {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Input placeholder="e.g., Blood Donation Camp" {...field} /></FormControl>
                  <FormMessage />
                </FormItem>
              )}
            />
