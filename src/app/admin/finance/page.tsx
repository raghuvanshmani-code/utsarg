...
import { Home, BookOpen, Calendar, GalleryHorizontal, Newspaper, LogOut, Database, PlusCircle, MoreHorizontal, Pencil, Trash2, Loader2, Upload, HeartHandshake, IndianRupee, Users } from "lucide-react";
      ...
      <Sidebar>
        ...
        <SidebarContent>
          <SidebarMenu>
            ...
            <SidebarMenuItem>
                <SidebarMenuButton asChild tooltip={{children: 'Finance'}} isActive>
      ...
      <SidebarInset>
        <header className="flex h-14 items-center gap-4 border-b bg-muted/40 px-6">
          ...
          <div className="flex-1 flex justify-between items-center">
            <h1 className="text-lg font-semibold">Finance Management</h1>
                ...
                <TableBody>
                    {transactions.map((transaction) => (
                        <TableRow key={transaction.id}>
                            ...
                            <TableCell className="font-medium">{transaction.purpose}</TableCell>
