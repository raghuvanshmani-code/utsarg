...
import { Loader2, UploadCloud, Home, BookOpen, Calendar, GalleryHorizontal, Newspaper, LogOut, Database, Upload, AlertTriangle, FileJson, CheckCircle, XCircle, HeartHandshake, IndianRupee } from 'lucide-react';
